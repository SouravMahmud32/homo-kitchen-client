      ...
      <div className="bg-white p-10 md:w-3/4 lg:w-1/2 mx-auto">
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex items-center mb-5">
            ...
            <textarea type="text"
              name="price" className="textarea flex-1 py-2 border-b-2 border-gray-400 focus:border-green-400 text-gray-600 placeholder-gray-400 outline-none" placeholder="your opinion"></textarea>
          </div>
